...
quantile3  <- planilla_cazatalentos[ ids_juegan1, quantile(aciertos1)[4] ]
ids_juegan2  <- planilla_cazatalentos[ ids_juegan1 ][aciertos1 >= quantile3, id ]
...
planilla_cazatalentos[ ids_juegan2, quantile(aciertos_cum1)[4] ]
planilla_cazatalentos[ ids_juegan2, median(aciertos_cum1) ]

#El cazatalentos toma una decision, elige al que mas aciertos tuvo en la ronda2
pos_mejor <-  planilla_cazatalentos[ , which.max(aciertos_cum1) ]
