...
Estrategia_B  <- function()
{
  ...
  planilla_cazatalentos[ ids_juegan1,  tiros1 := 100 ]  #registro en la planilla que tiran X tiros
  ...
  # quantile  <- planilla_cazatalentos[ ids_juegan1, quantile(aciertos1)[1] ]
  # ids_juegan2  <- planilla_cazatalentos[ ids_juegan1 ][ aciertos1 >= quantile, id ]
  
  planilla_cazatalentos[ ids_juegan2,  tiros2 := 10 ]  #registro en la planilla que tiran X tiros
  ...
  planilla_cazatalentos[, aciertos_cum1 := aciertos1 + aciertos2]
  mediana <- planilla_cazatalentos[ ids_juegan2, median(aciertos_cum1) ]
  ids_juegan3  <- planilla_cazatalentos[ ids_juegan2 ][ aciertos_cum1 >= mediana, id ]

  planilla_cazatalentos[ ids_juegan3,  tiros3 := 10 ]  #registro en la planilla que tiran 70 tiros
  resultado3  <- gimnasio_tirar( ids_juegan3, 10)
  ...
  # #A la mitad mejor la hago tirar 70 tiros cada uno
  # #La mediana siempre parte a un conjunto en dos partes de igual cantidad
  planilla_cazatalentos[, aciertos_cum2 := aciertos_cum1 + aciertos3]
  mediana  <- planilla_cazatalentos[ ids_juegan3, median(aciertos_cum2) ]
  ids_juegan4  <- planilla_cazatalentos[ ids_juegan3 ][ aciertos_cum2 >= mediana, id ]

  planilla_cazatalentos[ ids_juegan4,  tiros4 := 10 ]  #registro en la planilla que tiran 70 tiros
  resultado4  <- gimnasio_tirar( ids_juegan4, 10)
  ...
  # #A la mitad mejor la hago tirar 70 tiros cada uno
  # #La mediana siempre parte a un conjunto en dos partes de igual cantidad
  planilla_cazatalentos[, aciertos_cum3 := aciertos_cum2 + aciertos4]
  mediana  <- planilla_cazatalentos[ ids_juegan4, median(aciertos_cum3) ]
  ids_juegan5  <- planilla_cazatalentos[ ids_juegan4 ][ aciertos_cum3 >= mediana, id ]
  ...
  #La mediana siempre parte a un conjunto en dos partes de igual cantidad
  planilla_cazatalentos[, aciertos_cum4 := aciertos_cum3 + aciertos5]
  mediana  <- planilla_cazatalentos[ids_juegan5, median(aciertos_cum4) ]
  ids_juegan6  <- planilla_cazatalentos[ ids_juegan5 ][ aciertos_cum4 >= mediana, id ]

  planilla_cazatalentos[ ids_juegan6,  tiros6 := 10 ]  #registro en la planilla que tiran 200 tiros
  resultado6  <- gimnasio_tirar( ids_juegan6, 10)
  planilla_cazatalentos[ ids_juegan6,  aciertos6 := resultado6 ]  #registro en la planilla
  
  
  #Ronda 7 -------------------------------------------------------
  planilla_cazatalentos[, aciertos_cum5 := aciertos_cum4 + aciertos6]
  mediana  <- planilla_cazatalentos[ids_juegan6, median(aciertos_cum5) ]
  ids_juegan7  <- planilla_cazatalentos[ ids_juegan6 ][ aciertos_cum5 >= mediana, id ]
  
  planilla_cazatalentos[ ids_juegan7,  tiros7 := 100 ]  #registro en la planilla que tiran 200 tiros
  resultado7  <- gimnasio_tirar( ids_juegan7, 100)
  ...
  planilla_cazatalentos[, aciertos_cumfin := aciertos_cum5 + aciertos7]
  pos_mejor <-  planilla_cazatalentos[ , which.max(aciertos_cumfin) ]
