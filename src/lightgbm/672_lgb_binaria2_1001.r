...
hs <- makeParamSet( 
         ...
         makeIntegerParam("min_data_in_leaf", lower= 10    , upper= 120),
         makeIntegerParam("num_leaves",       lower=2L   , upper= 50),
         ...
         makeIntegerParam("max_bin",       lower=    2L   , upper= 6L),
         ...
         makeNumericParam("prob_corte",       lower= 0.014, upper=    0.05)
        )
