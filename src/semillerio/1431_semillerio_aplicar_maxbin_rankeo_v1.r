...
kexperimento  <- NA
kscript         <- "s1431_rankeo_70"


kcantidad_semillas  <- 70

#ATENCION
#aqui deben ir los mejores valores que salieron de la optimizacion bayesiana
x  <- list()
x$gleaf_size   <-  74.001423800318
x$gnum_leaves  <-  0.166069072884618
x$learning_rate <-  0.11646021939924
x$feature_fraction <-  0.418854409083027
x$max_bin  <-  111
x$num_iterations  <-83   
x$pos_ratio  <- 0.043148971069435
...
param_buenos  <- list( objective= "binary",
                       ...
                       lambda_l1= 5,
                       lambda_l2= 23,
                       bagging_fraction = 0.728397211506643,
                       path_smooth = 0.454842005717852,
