...
x  <- list()
x$gleaf_size   <-  53.0560797502016
x$gnum_leaves  <-  0.0930771911764043
x$learning_rate <-  0.14027096789854
x$feature_fraction <-  0.294745389994558
x$max_bin  <-  110
x$num_iterations  <-127   
x$pos_ratio  <- 0.040303616111404
...
param_buenos  <- list( objective= "binary",
                       ...
                       lambda_l1= 8,
                       lambda_l2= 15,
                       bagging_fraction = 0.340971074010827,
                       path_smooth = 0.518707574494816,
