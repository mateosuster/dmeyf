...
x  <- list()
x$gleaf_size   <-  63.7775401321358
x$gnum_leaves  <-  0.149236700675632
x$learning_rate <-  0.113760121999297
x$feature_fraction <-  0.337868549579585
x$max_bin  <-  75
x$num_iterations  <-128   
x$pos_ratio  <- 0.0420526725414878
...
param_buenos  <- list( objective= "binary",
                       ...
                       lambda_l1= 6,
                       lambda_l2= 21,
                       bagging_fraction = 0.0420526725414878,
                       path_smooth = 0.345082754562148,
