...
kscript       <- "1421_lgbm_maxbin_rankeo"

karchivo_dataset   <-  "./datasets/dataset_epic_v_rankeo.csv.gz"
...
hs <- makeParamSet( 
         makeIntegerParam("max_bin",          lower=   25      , upper=  130),
         makeNumericParam("learning_rate",    lower=   0.1   , upper=    0.2),
         makeNumericParam("feature_fraction", lower=    0.1    , upper=    1.0),
         makeNumericParam("gleaf_size",       lower=  50.0    , upper=  80.0),
         makeNumericParam("gnum_leaves",      lower=   0.01   , upper=    0.3),
         
         makeIntegerParam("lambda_l1",       lower=    0   , upper= 75),
         makeIntegerParam("lambda_l2",       lower=    0   , upper= 150),
