...
karch_dataset  <- "./datasets/dataset_epic_vFExFI.csv.gz"
ksalida  <- "semillerio" 
...
x  <- list()
x$gleaf_size   <- 57.7948637548473
x$gnum_leaves  <-  0.24501880985605
x$learning_rate <-  0.190134570839701
x$feature_fraction <-  0.16206009635149
x$max_bin  <-  117
x$num_iterations  <-226.9   
x$pos_ratio  <- 0.0406885758998435
...
param_buenos  <- list( objective= "binary",
                       ...
                       lambda_l1= 58,
                       lambda_l2= 21,
                       bagging_fraction = 0.144581369822675,
                       path_smooth = 0.350627476449824,
