...
kexperimento  <- NA
kscript         <- "s1431_rankeo"


kcantidad_semillas  <- 120

#ATENCION
#aqui deben ir los mejores valores que salieron de la optimizacion bayesiana
x  <- list()
x$gleaf_size   <-  70.6570009221359
x$gnum_leaves  <-  0.154176114950032
x$learning_rate <-  0.116420847713514
x$feature_fraction <-  0.248889135182832
x$max_bin  <-  110
x$num_iterations  <-107   
x$pos_ratio  <- 0.0431824458336472
...
param_buenos  <- list( objective= "binary",
                       ...
                       lambda_l1= 6,
                       lambda_l2= 21,
                       bagging_fraction = 0.629506038330847,
                       path_smooth = 0.388208110111192,
