...
kscript       <- "1421_lgbm_maxbin_rankeo_historico"
...
hs <- makeParamSet( 
         ...
         makeNumericParam("learning_rate",    lower=   0.1   , upper=    1),
         makeNumericParam("feature_fraction", lower=    0.1    , upper=    1.0),
         makeNumericParam("gleaf_size",       lower=  20.0    , upper=  100.0),
         makeNumericParam("gnum_leaves",      lower=   0.01   , upper=    0.5),
         
         makeIntegerParam("lambda_l1",       lower=    0   , upper= 75),
         makeIntegerParam("lambda_l2",       lower=    0   , upper= 100),
         makeIntegerParam("min_gain_to_split",       lower=    0   , upper= 150),
