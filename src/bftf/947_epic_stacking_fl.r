...
kscript         <- "947_mi_primer_stacking"

karch_dataset    <- "./datasets/dataset_stacking_v001.csv.gz"   #Cambiar version segun script anterior
...
ksemilla_azar  <- 488153 #Aqui poner la propia semilla
#------------------------------------------------------------------------------
...
EstimarGanancia_lightgbm  <- function( x )
{
  ...
  param_basicos  <- list( objective= "binary",
                          ...
                          verbosity= -100,
                          seed= 45848748,
                          max_depth=  -1,         #MODIFICADO  # -1 significa no limitar,  por ahora lo dejo fijo
