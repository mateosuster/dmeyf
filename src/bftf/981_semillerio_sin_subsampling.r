...
kscript         <- "981_epic_sin_subsampling"
...
kgen_subsampling <- 1     #esto es NO hacer undersampling
...
param_basicos  <- list( objective= "binary",
                        ...
                        max_bin= 30,            #por ahora, lo dejo fijo
...
param_ganadores  <- list( "learning_rate"= 0.071033852590394, 
                          "feature_fraction"= 0.786130698214926,
                          "min_data_in_leaf"= 2261,
                          "num_leaves"= 783,
                          "num_iterations"= 214,
                          "ratio_corte"= 0.0389102290510741,
                          "lambda_l1" = 20,
                          "lambda_l2" = 0,
                          "min_gain_to_split"= 1,
                          "bagging_fraction" = 0.642335030247545,
                          "path_smooth" = 0.642335030247545
                        )
...
t1 = Sys.time()
delta = t1- t0
fwrite(x = data.table(delta), file = paste0("./work/E",  kexperimento, "delta.txt"))
