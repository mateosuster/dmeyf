...
modelo_nuevo  <- copy(  modelo2[  , c("numero_de_cliente"), with=FALSE ] )

modelo_nuevo[ , ranking  :=  120*modelo2$ranking +50*modelo4$ranking ]   #ATENCION  el 200 es por las 200 semillas del modelo1, y el 70 por las 70 del modelo2
