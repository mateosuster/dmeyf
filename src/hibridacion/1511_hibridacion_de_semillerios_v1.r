...
arch1  <- "./kaggle/kaggle_E5019_meseta_E5019_s1431_v1_150_11000.csv"
arch2  <- "./kaggle/kaggle_E5025_meseta_E5025_s1431_rankeo_70_70_12000.csv"


kexperimento <-  NA

kscript <-  "s1511_primera_hibridacion"
...
modelo_nuevo[ , ranking  :=  150*modelo1$ranking + 70*modelo2$ranking ]   #ATENCION  el 200 es por las 200 semillas del modelo1, y el 70 por las 70 del modelo2
