...
arch2  <- "./kaggle/E1053/E1053_s1511_2da_hibridacion__14000.csv"
arch4  <- "./kaggle/E1056/E1056_s1511_3ra_hibridacion__14000.csv"


kexperimento <-  NA

kscript <-  "s1511_hibridacion_de_hibri_1y2"
...
modelo_nuevo[ , ranking  :=  110*modelo2$ranking +85*modelo4$ranking ]   #ATENCION  el 200 es por las 200 semillas del modelo1, y el 70 por las 70 del modelo2
